...
C_52_figure_like_J_rotated::C_52_figure_like_J_rotated()
{
	length = 6;
	height = 2;
	bottom_y = 2;
...
void C_52_figure_like_J_rotated::Show()
{
...
void C_52_figure_like_J_rotated::Show_after_rotation(int rotated_left_x, int rotated_top_y)
{
	top_y = rotated_top_y;
...
bool C_52_figure_like_J_rotated::Move_down(int current_level)
{
	while (!_kbhit())
...
void C_52_figure_like_J_rotated::Erase()
{
	COORD position;
...
bool C_52_figure_like_J_rotated::Move_left()
{
...
bool C_52_figure_like_J_rotated::Move_right()
{
...
bool C_52_figure_like_J_rotated::Rotatable(int & rotated_left_x, int & rotated_top_y, bool & rotated_shift)
{
	...
	if (!Check_for_free_cell(left_x - 1, top_y) && !Check_for_free_cell(left_x + 2, top_y)) return false;
