...
C_51_figure_like_J_rotated::C_51_figure_like_J_rotated()
{
	length = 4;
	height = 3;
	bottom_y = 3;
...
void C_51_figure_like_J_rotated::Show()
{
...
void C_51_figure_like_J_rotated::Show_after_rotation(int rotated_left_x, int rotated_top_y)
{
	top_y = rotated_top_y;
...
bool C_51_figure_like_J_rotated::Move_down(int current_level)
{
	while (!_kbhit())
...
void C_51_figure_like_J_rotated::Erase()
{
	COORD position;
...
bool C_51_figure_like_J_rotated::Move_left()
{
...
bool C_51_figure_like_J_rotated::Move_right()
{
...
bool C_51_figure_like_J_rotated::Rotatable(int & rotated_left_x, int & rotated_top_y, bool & rotated_shift)
{
	...
	if (!Check_for_free_cell(left_x, bottom_y + 1) && !Check_for_free_cell(left_x, top_y + 1)) return false;
