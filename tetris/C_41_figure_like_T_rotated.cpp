...
C_41_figure_like_T_rotated::C_41_figure_like_T_rotated()
{
	length = 4;
	height = 3;
	bottom_y = 3;
...
void C_41_figure_like_T_rotated::Show()
{
...
void C_41_figure_like_T_rotated::Show_after_rotation(int rotated_left_x, int rotated_top_y)
{
	top_y = rotated_top_y;
...
bool C_41_figure_like_T_rotated::Move_down(int current_level)
{
	while (!_kbhit())
...
void C_41_figure_like_T_rotated::Erase()
{
	COORD position;
...
bool C_41_figure_like_T_rotated::Move_left()
{
...
bool C_41_figure_like_T_rotated::Move_right()
{
...
bool C_41_figure_like_T_rotated::Rotatable(int & rotated_left_x, int & rotated_top_y, bool & rotated_shift)
{
	...
	if (!Check_for_free_cell(right_x, top_y) && !Check_for_free_cell(right_x, bottom_y)) return false;
