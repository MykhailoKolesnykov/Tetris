...
C_31_figure_like_Z_rotated::C_31_figure_like_Z_rotated()
{
	length = 4;
	height = 3;
	bottom_y = 3;
...
void C_31_figure_like_Z_rotated::Show()
{
...
void C_31_figure_like_Z_rotated::Show_after_rotation(int rotated_left_x, int rotated_top_y)
{
	top_y = rotated_top_y;
...
bool C_31_figure_like_Z_rotated::Move_down(int current_level)
{
	while (!_kbhit())
...
void C_31_figure_like_Z_rotated::Erase()
{
	COORD position;
...
bool C_31_figure_like_Z_rotated::Move_left()
{
...
bool C_31_figure_like_Z_rotated::Move_right()
{
	if (!Check_for_free_cell(right_x + 2, top_y)) return false;
...
bool C_31_figure_like_Z_rotated::Rotatable(int & rotated_left_x, int & rotated_top_y, bool & rotated_shift)
{
